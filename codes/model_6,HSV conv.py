...
training_set = train_datagen.flow_from_directory('C:/Users/Rena/Desktop/HSV_data/train',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary') 

test_set = test_datagen.flow_from_directory('C:/Users/Rena/Desktop/HSV_data/test',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
model.summary()
...
disk_dir= Path('C:/Users/Rena/Desktop/HSV_data/test/abnormal')
...
X_data = []
files= glob.glob('C:/Users/Rena/Desktop/Sxolh/Πτυχιακη/Step_1/data/test/abnormal/*.jpg')
for myFile in files:
    print(myFile)
